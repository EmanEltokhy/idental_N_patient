                            ...
                            child: Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color:
                                  AppCubit.get(context).currentIndex == index ? Colors.white : null,
                                ),
                              ),
                            ),
                          );
                      ...
                      child: Container(
                        ...
                        child: Button(
                          ...
                          onPressed: () async {
                            ...
                            final getDate = DateConverted.getDate(AppCubit.get(context).currentDay);
                            final getDay = DateConverted.getDay(AppCubit.get(context).currentDay.weekday);
                            final getTime = DateConverted.getTime(AppCubit.get(context).currentIndex!);
                          ...
                          disable: AppCubit.get(context).timeSelected && AppCubit.get(context).dateSelected ? false : true,
                        ),
                      ),
                    ),
                  ],
